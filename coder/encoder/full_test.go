...
func fullEncoderFlow(t *testing.T, enc encoder.Encoder, pieceCount, codedPieceCount int, pieces []coder.Piece) {
...
func TestNewFullRLNCEncoder(t *testing.T) {
	...
	fullEncoderFlow(t, enc, pieceCount, codedPieceCount, pieces)
}
...
func TestNewFullRLNCEncoderWithPieceCount(t *testing.T) {
	...
	fullEncoderFlow(t, enc, int(pieceCount), int(codedPieceCount), pieces)
}
...
func TestNewFullRLNCEncoderWithPieceSize(t *testing.T) {
	...
	enc, err := encoder.NewFullRLNCEncoderWithPieceSize(data, pieceSize)
	if err != nil {
		t.Fatal(err.Error())
	}
